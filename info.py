...
BOT_TOKEN = environ.get('BOT_TOKEN', "7924974185:AAE4U01BiomfVncoCYhxVDAI3dQfLc-0cFE")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 1800))
PICS = (environ.get('PICS', 'https://envs.sh/WnU.jpg')).split() #SAMPLE PIC
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5826767568').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001812588767').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002141922564') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://vocom11581:EGUhDKhykg5fBxPA@cluster0.ixgzc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+M71jOVrHkNwwNzM1')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Howtodownlodallmovies/60')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'starkx77') # Support Chat Link Without https:// or @
